      ...
      >
        ...
        >
          <Grid item xs={12}>
            ...
            {/* <DocumentPdf /> */}
            {/* </SubCard> */}
            <Timeline position="alternate" className="timeline_profile">
              <TimelineItem>
                ...
                <TimelineContent sx={{ py: "12px", px: 2 }}>
                  ...
                  >
                    ...
                    higher diploma in software engineering. I have over 10 years
                    experience in web application development, especially in
                    frontend web development. I develop HTML / CSS / and
                    javascript coding, making the site responsive and friendlier
                    to smaller devices is one of my main aims as well as
                    improving performance. Through the professional knowledge I
                    have and with my experience, I will try to do the best job
                    at the company. Constantly strive for yourself and become
                    the core employee of the company in the coming time.
                  </Typography>
                </TimelineContent>
              </TimelineItem>
              <TimelineItem>
              ...
              <TimelineItem>
                ...
                <TimelineContent sx={{ py: "12px", px: 2 }}>
                  ...
                  >
                    - Development website application using MVC, SQL Server on
                    basic platform .NET 4.0, 4.5... And my specialize is develop
                    UI with script, jquery, css...
                  </Typography>
                  <Typography
                    color={theme.palette.grey[700]}
                    sx={{ wordBreak: "break-word" }}
                  >
                    ...
                    evaluation depend on your test, and they will give some idea
                    to help you ’nd out an opportunity develop.
                  </Typography>
                  <Typography
                    color={theme.palette.grey[700]}
                    sx={{ wordBreak: "break-word" }}
                  >
                    - moe project is a learning experience which aims to provide
                    students with the opportunity to synthesise knowledge from
                    various areas of learning, and critically and creatively
                    apply it to real life situations. This process, which
                    enhances students& knowledge and enables them to acquire
                    skills like collaboration, communication and independent
                    learning, prepares them for lifelong learning and the
                    challenges ahead.
                  </Typography>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ wordBreak: "break-word" }}
                  >
                    Analysis, programming and development website application on
                    the basic platform .NET 2.0, 3.5, 4.0... using ASP.NET, MVC,
                    Entity Framework, Web services, html, jquery, css...
                  </Typography>
                </TimelineOppositeContent>
                <TimelineSeparator>
                  <TimelineConnector />
